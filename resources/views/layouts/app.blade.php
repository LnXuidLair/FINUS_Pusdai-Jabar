...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/images/favicon.ico') }}?v=6">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/favicon.ico') }}?v=6">

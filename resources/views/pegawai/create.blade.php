            ...
            <div class="fmu-card-body">
                <div class="fmu-form-grid">
                    ...
                    <div class="fmu-field">
                        ...
                        <div class="fmu-input-icon-wrap"><i class="fa-solid fa-envelope"></i><input type="email" id="email_preview" value="otomatis@{{ $staffDomain }}" class="fmu-control" readonly></div>
...
{{-- FINUS DARK MODE LOCAL: pegawai/create.blade.php --}}
@push('dark-styles')
<style data-finus-dark-local="pegawai/create.blade.php">

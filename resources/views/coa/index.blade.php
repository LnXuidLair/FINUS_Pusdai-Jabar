        ...
        <div class="finus-data-hero-left">
            ...
            <div>
                ...
                <p class="finus-data-hero-subtitle" data-record-subtitle data-label="akun">
                    Kelola {{ number_format($totalAkun, 0, ',', '.') }} akun keuangan FINUS.
                </p>
            </div>
        </div>
            ...
            <div class="finus-data-card-title-wrap">
                ...
                <div>
                    ...
                    <p class="finus-data-card-description">
                        Daftar kode, nama, dan kelompok akun keuangan.
                    </p>
                </div>
            </div>
...
{{-- FINUS DARK MODE LOCAL: coa/index.blade.php --}}
@push('dark-styles')
<style data-finus-dark-local="coa/index.blade.php">
...
html[data-finus-theme="dark"] body .finus-data-page .finus-file-picker { border-color:#365442 !important; background:#0E1812 !important; }
html[data-finus-theme="dark"] body .finus-data-page .finus-file-picker:hover,
html[data-finus-theme="dark"] body .finus-data-page .finus-file-picker:focus-within { border-color:#64DD81 !important; background:#13251A !important; box-shadow:0 0 0 4px rgba(100,221,129,.09) !important; }
html[data-finus-theme="dark"] body .finus-data-page .finus-file-picker-icon { background:#173620 !important; color:#7BE795 !important; }
html[data-finus-theme="dark"] body .finus-data-page .finus-import-btn:not(.primary) { border-color:#34523F !important; background:#14261B !important; color:#C9EFD2 !important; }
html[data-finus-theme="dark"] body .finus-data-page .finus-import-btn:not(.primary):hover { background:#193021 !important; border-color:#41634C !important; }
</style>
@endpush

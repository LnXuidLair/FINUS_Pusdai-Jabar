...
<body>
            ...
            <div class="finus-container finus-faq-layout">
                ...
                <div class="finus-faq-list">
                    ...
                    <details class="finus-faq-item finus-scroll-card" style="--scroll-delay: 180ms">
                        ...
                        <p>
                            Ya. Tata letak, navigasi, kartu, formulir, dan tombol telah dibuat responsif
                            untuk desktop, laptop, tablet, serta berbagai ukuran layar ponsel.
                        </p>
                    </details>
                </div>
            </div>
        ...
        <div class="finus-modal-dialog">
            ...
            <div class="finus-modal-content">
                ...
                <div class="finus-code-field-wrap">
                    ...
                    <button type="button" class="finus-toggle-password" id="togglePassword"
                            aria-label="Tampilkan kode akses">
    ...
    (() => {
        ...
        const setVerifying = isVerifying => {
            ...
            verifySpinner.hidden = !isVerifying;
            verifyText.textContent = isVerifying
                ? 'Memverifikasi...'
                : 'Verifikasi';
        };
